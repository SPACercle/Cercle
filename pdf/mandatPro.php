<?php
    ...
    <div style='position:absolute;top:317;left:20'>La société ".$res2[0]['CLT-Nom'].", N° SIRET ".$_GET['siret']." représentée par ".$_GET['rep']."</div>
	<b><div style='position:absolute;top:372;left:20'><span>Donne Mandat à ".$res2[0]['CON-Prénom']." ".$res2[0]['CON-Nom'].", Gérant de la société ".$res2[0]['CON-Société']."</span></div></b>
	<div style='position:absolute;top:402;left:20'><span>SARL au Capital de 3774€ inscrite au Registre du commerce et des Sociétés de ".$res2[0]['CON-RCSVille']." sous le N° ".$res2[0]['CON-NumRCS']." -  Code APE ".$res2[0]['CON-APE']."</span></div>
	<div style='position:absolute;top:430;left:20'><span>Sise ".$res2[0]['CON-Adresse']." ".$res2[0]['CON-CP']." ".$res2[0]['CON-VIlle']."</span></div>
	<div style='position:absolute;top:461;left:20'><span>Immatriculée  à l'ORIAS sous le N° ".$res2[0]['CON-NumORIAS']." www.orias.fr et placée sous le contrôle de l'ACPR - 61 rue Taitbout - 75436 PARIS Cedex 09</span></div>

	<b><div style='position:absolute;top:522;left:20;line-height:15px;'><span>Afin qu'en mon nom, Social Concept Développement (ou ses partenaires) puisse recueillir auprès des employeurs, organismes de retraite ou de prévoyance, compagnies d'assurance ou institution de prévoyance par capitalisation ou par répartition, et plus généralement, à intervenir auprès de tout organisme nécessaire à l'élaboration de mon Audit Social, Fiscal ou Patrimonial.
	</span></div></b>

	<div style='position:absolute;top:679;left:20'><span>Fait en 2 exemplaires à ".$res2[0]['CLT-VillePro'].", le ".$date."</span></div>
	<div style='position:absolute;top:175;left:230'><span><h3>Mandat Administratif de Gestion</h3></span></div>
	<div style='position:absolute;top:798;left:455'><span>".$res2[0]['CON-Prénom']." ".$res2[0]['CON-Nom']."</span></div>
	";
	if($res2[0]['CLT-PrsMorale'] == 1){
		$content.="<div style='position:absolute;top:798;left:163'><span>Pour la société ".$res2[0]['CLT-Nom']."</span></div>";
	} else {
		$content.="<div style='position:absolute;top:798;left:163'><span>Pour ".$res2[0]['CLT-Nom']."</span></div>";
	}
	$content.="
	<div style='position:absolute;top:774;left:430'><span> L'intermédiaire en Assurances</span></div>
	<div style='position:absolute;top:774;left:140'><span>Le Candidat à l'Assurance</span></div>

	<div style='position:absolute;top:620;left:20'><span>Le présent mandat est valable à compter de ce jour pour une durée d'un an avec tacite reconduction. Il peut être résilié par lettre recommandée avec AR, à tout moment par l'une ou l'autre des partie moyennant un délai de préavis de 1 mois.
	</span></div>

	<div style='position:absolute;top:859;left:137'><span>Signature précédée de la mention</span></div>
	...
	<i><span style='color: #614B3A;font-size:10px;'><div style='position:absolute;top:985;left:55'>Loi du 6 janvier 1978 : Le(s) signataire(s) peut (peuvent) demander communication et rectification de toute information le concernant.</div></span></i>
	</span>
