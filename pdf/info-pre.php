<?php
    ...
    <span style='font-size:11.5px'>
		...
		<div style='position:absolute;top:347;left:30'>Le Cabinet ".$res2[0]['CON-Société']." est inscrit au Registre du commerce et des Sociétés de ".$res2[0]['CON-RCSVille']." sous le N° ".$res2[0]['CON-NumRCS']." -  Code APE ".$res2[0]['CON-APE'].". Son siège social est sis ".$res2[0]['CON-Adresse']." ".$res2[0]['CON-Adresse2']." ".$res2[0]['CON-CP']." ".$res2[0]['CON-VIlle'].". Le Cabinet ".$res2[0]['CON-Société']." est Immatriculé à l'ORIAS sous le N° ".$res2[0]['CON-NumORIAS']." en tant que Courtier d'Assurance. Cette immatriculation peut être vérifiée auprès de l'ORIAS sur son site internet www.orias.fr ou par courrier adressé à son attention au 1, rue Jules Lefebvre - 75731 PARIS Cedex 09.</div>
		...
		<div style='position:absolute;top:830;left:26'>Fait en 2 exemplaires à ".$res2[0]['CLT-Ville'].", le ".$date_un." en deux exemplaires, dont un pour ".$res2[0]['CIV-Nom']." ".$res2[0]['CLT-Prénom']." ".$res2[0]['CLT-Nom']." qui reconnait l'avoir reçu.</div></i>
    ...
    <span style='font-size:11px'><i>
  		...
  		<div style='position:absolute;top:233;left:30'>Les informations ci-après sont délivrées à l’attention de ".$res2[0]['CIV-Nom']." ".$res2[0]['CLT-Prénom']." ".$res2[0]['CLT-Nom']." né(e) le ".date('d/m/Y',strtotime($res2[0]['CLT-DateNaissance'])).", demeurant au ".$res2[0]['CLT-Adresse']." ".$res2[0]['CLT-Code Postal']." ".$res2[0]['CLT-Ville']." conformément aux dispositions des articles L520-1-II 2° du Code des assurances par ".$res2[0]['CON-Prénom']." ".$res2[0]['CON-Nom']." pour le compte du Cabinet ".$res2[0]['CON-Société']." .  </div>

		<div style='position:absolute;top:268;left:29'><h5><u>I- Importance des informations</u></h5></div>

		<div style='position:absolute;top:304;left:30'>Le ou les contrats proposés se fondent sur l'analyse de votre situation tant personnelle que professionnelle et des besoins que vous avez exprimés. Aussi, l'exactitude et l'exhaustivité de vos réponses sont essentielles. A défaut, l'appréciation de votre situation ne pourrait être que partielle et serait de nature à remettre en cause la qualité de notre mission d'intermédiation. De la même façon, en cours de contrat, l'assuré doit aviser notre cabinet par écrit de toute modification à venir dans sa situation (changement de statut, d'activité professionnelle, cessation d'activité, montant des revenus professionnels, situations ou sports à risques ....)</div>

		<div style='position:absolute;top:362;left:29'><h5><u>II- Transmission des informations</u></h5></div>

		<div style='position:absolute;top:398;left:30'>En nous communiquant votre adresse postale et/ou électronique, vous acceptez que les informations relatives à l’exécution de votre adhésion soient transmises à cette adresse. Vous pouvez nous demander à tout moment, par écrit, de cesser ce mode de communication. En cas de changement d’adresse postale et/ou électronique, Vous devez nous en avertir dans les plus brefs délais. A défaut, les courriers transmis à la dernière adresse connue produiront tous leurs effets. </div>

		<div style='position:absolute;top:441;left:29'><h5><u>III- Importance des conditions générales</u></h5></div>

		<div style='position:absolute;top:477;left:30'>Il est très important que vous lisiez attentivement les conditions générales valant note d'information de votre (ou vos) contrat(s) d'assurances, qui vous seront remises au moment de la signature du (ou des) document(s) d'adhésion. Les conditions générales constituent le document juridique contractuel exprimant les droits et obligations de l'assuré et de l'assureur. Nous attirons votre attention sur les paragraphes des conditions générales consacrées notamment aux risques exclus, à la durée d'adhésion de votre (ou vos) contrat(s), aux délais de carences qui peuvent être appliqués, période pendant laquelle l'assuré ne peut demander la mise en oeuvre de ses garanties, de franchise, période durant laquelle le sinistre reste à la charge de l'assuré(e), aux définitions des garanties ainsi qu'à leurs motifs et dates d'expiration.</div>

		<div style='position:absolute;top:543;left:29'><h5><u>IV- Importance de vos déclarations</u></h5></div>

		<div style='position:absolute;top:579;left:30'>Nous attirons votre attention sur l'importance de la précision et de la sincérité des réponses que vous apporterez aux questions posées par l'assureur, y compris la partie questionnaire de santé. Toute Inexactitude, omission, réticence ou fausse déclaration intentionnelle ou non de la part de l'assuré portant sur les éléments constitutifs du risque au moment de l'adhésion ou en cours d'adhésion, est sanctionnée même si elle a été sans influence sur le sinistre, par une réduction d'indemnité ou une nullité du contrat. De même toute ommission, réticence, fausse déclaration intentionnelle ou non dans la déclaration du sinistre expose l'assuré à une déchéance de garanties et à la résiliation de son adhésion. Le cabinet Social Concept Développement ne saurait être tenu responsable des conséquences qui en découleraient</div>

		<div style='position:absolute;top:642;left:29'><h5><u>V- Importance des cotisations</u></h5></div>
		
		<div style='position:absolute;top:678;left:30'>Vous attestez par la présente que les garanties proposées, les modalités de paiement des cotisations et leur évolution éventuelle ont été évoquées. Votre attention a été attirée sur le fait que l'interruption des cotisations périodiques entrainera pour certains dossier la résiliation automatique de certaines garanties (en cas d'incapacité, d'invalidité, ou de garanties de bonne fin en cas de décès par exemple), dans les délais prévus aux dispositions générales. Le défaut de paiement peut  provoquer la mise en réduction de l'adhésion avec toutes ses conséquences. Malgré le fait que certaines compagnies vous permettent à nouveau la reprise de ces versements, nous vous engageons à vous rapprocher de votre cabinet, pour en mesurer les risques et les conséquences</div>

		<div style='position:absolute;top:737;left:29'><h5><u>VI- Prise d'effet des garanties</u></h5></div>

		<div style='position:absolute;top:770;left:30'>La prise d'effet des garanties indiquée sur le Certificat d’adhésion par la compagnie d'Assurances, est liée aux conditions suspensives du paiement de la première cotisation et sous réserve d’acceptation par cette même compagnie, concrétisée par l’émission d’un Certificat d’adhésion précisant le montant des garanties pour chacun des risques couverts. Note de couverture : L’Assuré peut bénéficier d’une garantie supplémentaire temporaire en cas de décès suite à un Accident survenu entre la date de signature de la demande d’adhésion et la date d’acceptation par la compagnie d'Assurances.</div>

		<div style='position:absolute;top:842;left:30'><span style='color: #614B3A;'>Les informations recueillies sont nécessaires au traitement de votre demande en matière d'assurance et peuvent faire l'objet d'un traitement informatique. Le destinataire des données est la société Stratégies & Perspectives d'Avenir. Le fichier est enregistré à la CNIL sous le N° 1525993. Conformément à l'article 23 de la loi Informatique et libertés N° 78-17 du 6 janvier 1978 modifiée en 2004, vous bénéf iciez d'un droit d'accès et de rectification aux informations vous concernant, que vous pouvez exercer en vous adressant à Stratégies &amp; perspectives d'Avenir - Pôle technologique Nancy - Brabois    6 allée Pelletier Doisy 54603 VILLERS LES NANCY Cedex</span></div>

		<div style='position:absolute;top:910;left:30'>Fait en 2 exemplaires à ".$res2[0]['CLT-Ville'].", le ".$date_deux." en deux exemplaires, dont un pour ".$res2[0]['CIV-Nom']." ".$res2[0]['CLT-Prénom']." ".$res2[0]['CLT-Nom']." qui reconnait l'avoir reçu.</div></i>

		<div style='position:absolute;top:951;left:494'> ".$res2[0]['CON-Prénom']." ".$res2[0]['CON-Nom']."</div>
		<div style='position:absolute;top:951;left:171'>".$res2[0]['CLT-Prénom']." ".$res2[0]['CLT-Nom']."</div>
		<div style='position:absolute;top:930;left:464'> L'intermédiaire en Assurances</div>
		<div style='position:absolute;top:930;left:183'>Le Candidat à l'Assurance</div>
