<?php
    ...
    <span style='font-size:11px'><i>
  		...
  		<div style='position:absolute;top:167;left:30'>Cette fiche est destinée à améliorer votre compréhension des garanties proposées afin de vous permettre de mieux appréhender les propositions d'assurances qui vous seront faites et ainsi choisir librement vos solutions d'assurance comme vous le permet la loi.  </div>

  		<div style='position:absolute;top:203;left:30'>Les informations ci-après sont délivrées à l’attention de ".$res2[0]['CIV-Nom']." ".$res2[0]['CLT-Prénom']." ".$res2[0]['CLT-Nom']." né(e) le ".date('d/m/Y',strtotime($res2[0]['CLT-DateNaissance'])).", demeurant au ".$res2[0]['CLT-Adresse']." ".$res2[0]['CLT-Code Postal']." ".$res2[0]['CLT-Ville']." conformément aux dispositions des articles L520-1-II 2° du Code des assurances par ".$res2[0]['CON-Prénom']." ".$res2[0]['CON-Nom']." pour le compte du Cabinet ".$res2[0]['CON-Société']." .  </div>
		...
		<div style='position:absolute;top:880;left:30'>Fait en 2 exemplaires à ".$res2[0]['CLT-Ville'].", le ".$date_deux." en deux exemplaires, dont un pour ".$res2[0]['CIV-Nom']." ".$res2[0]['CLT-Prénom']." ".$res2[0]['CLT-Nom']." qui reconnait l'avoir reçu.</div></i>
		...
		<div style='position:absolute;top:915;left:183'>Le Candidat à l'Assurance</div>
