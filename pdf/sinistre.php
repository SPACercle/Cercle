<?php
	...
	<page_header>
        ...
        <div style=position:absolute;top:28;left:26><b>Procédure de traitement SINISTRE</b></div>
        <div style='position:absolute;top:56;left:26'><b>Responsable Ali TAZI</b></div>
    ...
    <span style='font-size:11px'>
        ...
        <div style='position:absolute;top:933;left:30'>3-Questionnaire :</div>
        <div style='position:absolute;top:947;left:30'>Questionnaire Pas du tout satisfait Un peu satisfait Moyennement satisfait Satisfait Très satisfait</div>
        <div style='position:absolute;top:961;left:30'>Qualité de l’accueil     </div>
        <div style='position:absolute;top:976;left:30'>Qualité de la réponse     </div>
        <div style='position:absolute;top:991;left:30'>Les délais de la réponse     </div>
        <div style='position:absolute;top:1005;left:30'>Le traitement du dossier compagnie     </div>
        <div style='position:absolute;top:1020;left:30'>Le traitement du dossier cabinet     </div>
        <div style='position:absolute;top:1040;left:30'>4-Commentaires libres :</div></i>
        <div style='position:absolute;top:603;left:26'><h5><u>9) Questionnaire de satisfaction</u></h5></div>
